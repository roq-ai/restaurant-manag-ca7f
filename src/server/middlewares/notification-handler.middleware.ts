...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': { roles: ['owner', 'manager'], key: 'order', tenantPath: [], userPath: [] },
  'payment.create.create': { roles: ['owner', 'manager'], key: 'payment', tenantPath: [], userPath: [] },
  'feedback.create.create': { roles: ['owner', 'manager'], key: 'feedback', tenantPath: [], userPath: [] },
};
